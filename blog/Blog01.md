...
| Game Systems | - Exploration <br> - Puzzle-solving <br> - Dialogue and story choices <br> - Memory collection (to unlock backstory) <br> - Light combat (if included) |
| Interactivity | - The player can move in all directions using first-person controls <br> - Interact with objects and NPCs <br> - Solve environmental puzzles to unlock new areas and memories <br> - Use abilities to overcome obstacles and enemies |
